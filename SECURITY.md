...
Only the latest `0.1.x` prerelease receives security fixes. Older prereleases may
be deprecated rather than patched. This policy will be revised before a stable
`1.0.0` release.
